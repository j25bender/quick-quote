...
describe('reducers Tests', () => {
  ...
  it('action type ADD_RANDOM_QUOTE should cause randomQuoteReducer to update store', () => {
    const randomQuoteAction = { type: 'ADD_RANDOM_QUOTE', randomQuoteToDispatch: mockQuoteData }
  ...
  it('action type ADD_HOME_QUOTE should cause homeQuoteReducer to update store', () => {
    const homeQuoteAction = { type: 'ADD_HOME_QUOTE', homeQuoteToDispatch: mockQuoteData }
  ...
  it('action type ADD_CATEGORY_QUOTE should cause categoryQuoteReducer to update store', () => {
    const categoryQuoteAction = { type: 'ADD_CATEGORY_QUOTE', categoryQuoteToDispatch: mockQuoteData }
